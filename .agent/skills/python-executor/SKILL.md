...
Execute Python code in a safe, sandboxed environment with 100+ pre-installed libraries via [inference.sh](https://inference.sh).
...
- [Source](https://github.com/inference-sh/skills/tree/main/tools/utilities/python-executor)
