...
WALLETS: dict[str, WalletConfig] = {
    ...
    "primary": WalletConfig(
        ...
        solana_private_key_env="SOLANA_PRIVATE_KEY_PRIMARY",  # FIX: was SOLANA_PRIVATE_KEY (undefined)
        solana_address="",  # Not used for Solana per user instruction
    ...
    "wallet_b": WalletConfig(
        ...
        solana_private_key_env="SOLANA_PRIVATE_KEY_B",  # FIX: was SOLANA_PRIVATE_KEY (undefined)
        solana_address=os.getenv("SOLANA_ADDRESS_B", "GemWJXJGsgJHqTKER2fXr9TQrcE2rHLUNzWVm8VHdV3E"),
    ...
    "wallet_sol_alpha": WalletConfig(
        ...
        solana_private_key_env="SOLANA_PRIVATE_KEY_PRIMARY",  # FIX: was SOLANA_PRIVATE_KEY (undefined); sol_alpha shares primary Solana key
        ...
        strategies=["gem_snipe", "momentum", "breakout"],
        chains=["solana"],
        max_position_size_pct=20.0, # Reduced to use judiciously
        max_concurrent_positions=2,
        daily_loss_limit_eth=0.5, # Lowered loss limit to protect limited capital
