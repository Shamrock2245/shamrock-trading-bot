...
HYPERLIQUID_MAX_POSITION_USD = float(os.getenv("HYPERLIQUID_MAX_POSITION_USD", "250.0"))
HYPERLIQUID_MAX_NOTIONAL_USD = float(os.getenv("HYPERLIQUID_MAX_NOTIONAL_USD", "250.0"))
HYPERLIQUID_HIGH_VOL_MAX_NOTIONAL_USD = float(os.getenv("HYPERLIQUID_HIGH_VOL_MAX_NOTIONAL_USD", "100.0"))
HYPERLIQUID_MAX_TOTAL_EXPOSURE = float(os.getenv("HYPERLIQUID_MAX_TOTAL_EXPOSURE", "1500.0"))
HYPERLIQUID_USE_TESTNET = os.getenv("HYPERLIQUID_USE_TESTNET", "false").lower() == "true"
HYPERLIQUID_STOP_LOSS_PCT = float(os.getenv("HYPERLIQUID_STOP_LOSS_PCT", "2.0"))     # Tight 2% hard SL
HYPERLIQUID_TAKE_PROFIT_PCT = float(os.getenv("HYPERLIQUID_TAKE_PROFIT_PCT", "8.0"))   # 8% TP (4:1 R/R)
HYPERLIQUID_MAX_POSITIONS = int(os.getenv("HYPERLIQUID_MAX_POSITIONS", "5"))
HYPERLIQUID_DAILY_LOSS_LIMIT = float(os.getenv("HYPERLIQUID_DAILY_LOSS_LIMIT", "100.0"))  # Max $100/day loss
HYPERLIQUID_MIN_GEM_SCORE = float(os.getenv("HYPERLIQUID_MIN_GEM_SCORE", "58.0"))
