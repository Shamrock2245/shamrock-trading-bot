...
with tab_moralis:
    ...
    endpoint_table = [
        ...
        ("GET /discovery/tokens/trending", "moralis_money.py", "🟢 ACTIVE", "Trending token discovery"),
        ("GET /discovery/tokens/top-gainers", "moralis_money.py", "🟢 ACTIVE", "1h breakout momentum discovery"),
        ("GET /discovery/tokens/top-losers", "moralis_money.py", "🟢 ACTIVE", "Mean-reversion candidates (Wallet B)"),
        ("GET /discovery/tokens/buying-pressure", "moralis_money.py", "🟢 ACTIVE", "Rising buy:sell ratio detection"),
        ("GET /discovery/tokens/filtered", "moralis_money.py", "🟢 ACTIVE", "Smart money filtered tokens ($75k+ liq, 15+ exp buyers)"),
        ("GET /discovery/tokens/whale-accumulation", "moralis_money.py", "🟢 ACTIVE", "Net experienced buyers — strongest whale signal"),
        ...
        ("GET /token/{addr}/snipers", "moralis_solana.py", "🟢 ACTIVE", "Solana sniper detection at launch"),
