...
with tab_moralis:
    ...
    endpoint_table = [
        ...
        ("GET /tokens/top-gainers", "moralis_money.py", "🟢 ACTIVE", "1h breakout momentum discovery"),
        ("GET /tokens/top-losers", "moralis_money.py", "🟢 ACTIVE", "Mean-reversion candidates (Wallet B)"),
